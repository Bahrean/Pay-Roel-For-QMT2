    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="background-color:#001B07">
                <div class="card-header" style="background-color:#001B07">Edit Buyer Sent</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('send_to_buyer.update', $firebaseKey) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input style="background-color:#032E0E" id="item_name" type="text" class="form-control @error('item_name') is-invalid @enderror" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input style="background-color:#032E0E" id="price" type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input style="background-color:#032E0E" id="market_location" type="text" class="form-control @error('market_location') is-invalid @enderror" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input style="background-color:#032E0E" id="date_recorded" type="date" class="form-control @error('date_recorded') is-invalid @enderror" 
