            ...
            <div class="card shadow">
                <div class="card-body" style="background-color:#001B07">
                    <h6 class="card-title text-center" style="color: #001F77; font-size: 25px;font-weight: bold;">
                        <i class="fas fa-users"></i> Sent to Farmer
                    </h6>
                            ...
                            <tbody>
                                @foreach($marketPrices as $firebaseKey => $price)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('send_to_farmer.edit', $firebaseKey) }}" class="btn btn-sm btn-primary">Edit</a>
                                            <form action="{{ route('send_to_farmer.destroy', $firebaseKey) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
