<div class="fixed inset-0 flex h-full bg-white border lg:shadow-sm overflow-hidden lg:top-16 lg:inset-x-2 lg:m-auto lg:h-[90%] rounded-t-lg" style="background-color:rgb(31, 122, 54)">
